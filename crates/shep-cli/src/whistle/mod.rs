...
//! the schema-carrying payload twins every tool returns. The verb itself
//! (the `Whistle` handler, `get_info`, the stdio serve loop) is Task 8;
//! nothing here is reachable from `shep whistle` yet.

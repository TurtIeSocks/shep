...
//! recognize the name, how an echoed `id` gets a reply matched to its exact
//! trigger and what the name-and-order fallback costs an app that does not
//! echo it, and the `params` quoting gap — wants `docs/shepherd-channel.md`
